...
public class FipeSelectMotoActivity extends AppCompatActivity {
    ...
    public final static String IS_CAR = "cardealershipmanager.iscar";
    public final static String URL_FIPE_JSON_MARCAS = "http://fipeapi.appspot.com/api/1/motos/marcas.json";

    private Long marcaIdValue;
    private String modeloIdValue;
    private MarcaAdapter adapterMarca;
    private ModeloAdapter adapterModelo;
    private AnoVeiculoAdapter adapterAnoVeiculo;
    ...
    private void initBuscaModelo(Intent in) {
        ...
        final String urlBuscaModelo = "http://fipeapi.appspot.com/api/1/motos/veiculos/" + marcaIdValue + ".json";
    ...
    private void initBuscaAno(Intent in) {
        ...
        final String urlBuscaAno = "http://fipeapi.appspot.com/api/1/motos/veiculo/" + marcaIdValue + "/" + modeloIdValue + ".json";
    ...
    private void configureOnClickMarcaItem() {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getBaseContext(), FipeSelectMotoActivity.class);
